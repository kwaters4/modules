...
set_target_properties(Foo::foo_shared PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libfoo.so.1.2.3"
  IMPORTED_SONAME_RELEASE "libfoo.so.1"
  )

list(APPEND _cmake_import_check_targets Foo::foo_shared )
list(APPEND _cmake_import_check_files_for_Foo::foo_shared "${_IMPORT_PREFIX}/lib64/libfoo.so.1.2.3" )
